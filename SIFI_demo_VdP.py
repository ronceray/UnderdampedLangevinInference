...
# Import the package:
from StochasticInertialForceInference import *
...
S = StochasticInertialForceInference( data )
...
SIFI_plotting_toolkit.comparison_scatter(S.exact_F,S.ansatz_F,y=0.8,alpha=1)
...
plt.plot(data_bootstrap.X_ito[:,0,:],data_bootstrap.v_hat[:,0,:],color='r')
...
plt.subplot(H,W,6)
plt.title("Predicted trajectory")
plt.plot(data_bootstrap.t,data_bootstrap.X_ito[:,0,:],color='r')
